...
Director <- function(info) {
  return (paste(info$Title, "is directed by", info$Director))
}
...
movie.list <- c('High School Musical', 'Harry Potter', 'Annabelle')
